...
req_doc_tracker_id = 19									# The numerical ID of the tracker used to model the documents of requirements
...
req_sources_cf_id = 10									# The numerical ID of the custom_field used to store the RqSources of the requirement
...
req_value_cf_id = 44									# The numerical ID of the custom_field used to store the RqValue of the requirement
req_var_cf_id = 45										# The numerical ID of the custom_field used to store the RqVar of the requirement
req_chapter_cf_id = 43 									# The numerical ID of the custom_field used to store the RqChapter of the requirement
req_prefix_cf_id = 46									# The numerical ID of the custom_field used to store the requirements document prefix of the requirement
